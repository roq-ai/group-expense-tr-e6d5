  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless group expense management with Group Expense Tracker Application. Track, split, and share expenses effortlessly, keeping your financials organized and transparent."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1553729459-efe14ef6055d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxleHBlbnNlc3xlbnwwfHx8fDE2OTc2OTY0NzR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@alexandermils?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Alexander Mils`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless group expense management with Group Expense Tracker Application. Track, split, and share expenses effortlessly, keeping your financials organized and transparent.`}
            </Text>
            <Box

...
import { useGroupMemberCount, useGroupCount, useExpenseCount } from 'lib/roq';

import { GroupListPage as ShowCaseList } from 'pages/groups';

function DashboardPage() {
  const { session } = useSession();

  const groupMemberStat = useGroupMemberCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      title: 'Group Members',
      result: groupMemberStat?.data,
      isLoading: groupMemberStat.isLoading,
